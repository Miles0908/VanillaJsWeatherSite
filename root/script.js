...
const setBack = (weatherData) => {
  ...
  if (weather.includes("clear")) {
    modalContent.style.background =
      "url('root/./images/sunny-weather.jpg') no-repeat top / cover";
  } else if (weather.includes("cloud")) {
    modalContent.style.background =
      "url('root/./images/cloudy-weather.jpg') no-repeat center center / cover";
  } else if (weather.includes("rain")) {
    modalContent.style.background =
      "url('root/./images/rainy-weather.jpg') no-repeat center center / cover";
  } else if (weather.includes("snow")) {
    modalContent.style.background =
      "url('root/./images/snowy-weather.jpg') no-repeat center center / cover";
  } else {
    modalContent.style.background =
      "url('root/./images/default.jpg') no-repeat center center /cover";
  }
};
